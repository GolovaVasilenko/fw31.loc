...
<form class="form_add_page" method="post" action="/admin/page/add">
    <?php if(!empty($error)):?>
    ...
    <div class="form-group">
        ...
        <input id="h1" type="text" class="cyr form-control" name="h1" />
    </div>
    <div class="form-group">
        <label for="url">URL</label>
        <input id="url" type="text" class="lat form-control" name="url" />
    </div>
    <div class="form-group">
        <label for="body">Содержимое страницы</label>
        <textarea id="body" class="editor form-control" name="body"></textarea>
    </div>
    <div class="form-group">
    ...
    <input type="submit" value="Сохранить" class="btn btn-primary" name="add_page" />
</form>
